...
visibilityButton.addEventListener('click', () => {
  handleChangeVisibility(balanceElement, visibilityButton);
});
...
function handleChangeVisibility(elBalance, elBtn) {
  ...
  if (currentIsShown !== 'true') {
    elBalance.innerHTML = '*********';
    elBtn.classList.remove('icon-[material-symbols--visibility]');
    elBtn.classList.add('icon-[material-symbols--visibility-off]');
  } else {
    elBalance.innerHTML = balanceValue;
    elBtn.classList.remove('icon-[material-symbols--visibility-off]');
    elBtn.classList.add('icon-[material-symbols--visibility]');
  }
}